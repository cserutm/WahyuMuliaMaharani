...
<nav x-data="{ open: false }"
    ...
    <div x-show="open"
        ...
        <div class="py-2">
            ...
            <a href="{{ route('guru.leaderboard') }}" class="block px-4 py-3 border-b hover:bg-gray-50">Progres Belajar Siswa</a>
            ...
            <a href="{{ route('siswa.leaderboard') }}" class="block px-4 py-3 border-b hover:bg-gray-50">Progres Belajar</a>
