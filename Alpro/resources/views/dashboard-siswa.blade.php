            ...
            <div class="max-w-7xl mx-auto space-y-8">
                ...
                <section class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-6">
                    ...
                    <a href="{{ route('siswa.leaderboard') }}"
                        ...
                        <h3 class="text-xl font-bold text-blue-900 mb-2">Progress Belajar</h3>
                        <p class="text-sm text-slate-500 leading-relaxed">
                            Lihat progres belajarmu dan pantau perkembangan pemahaman materi yang telah kamu selesaikan di sini
                        </p>
                    </a>
