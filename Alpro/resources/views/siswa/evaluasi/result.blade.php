<x-app-layout>
    ...
    @if($score < 70)
        ...
        <script>
            ...
            function startGame() {
                clearInterval(gameInterval);
                gameInterval = setInterval(createFallingItem, 700); // item muncul setiap 700ms
            }

            function createFallingItem() {
                const item = document.createElement('div');
                const isVirus = Math.random() < 0.3; // menghasilkan angka acak 30% virus dan 70% item pemrograman
