            ...
            <main class="flex-1 ml-0 lg:ml-64 p-4 sm:p-6 lg:p-8 space-y-8"
                  ...
                  <div x-cloak
                        ...
                        <div @click.away="openEdit = false"
                              ...
                              <h2 class="text-2xl font-black text-blue-900 mb-5">
                                    Edit Materi
                              </h2>
                                    ...
                                    <form action="{{ route('guru.modul.update', $item->id) }}"
                                          ...
                                          <div>
                                                ...
                                                <textarea name="ringkasan"
                                                      rows="4"
                                                      class="w-full rounded-xl border-slate-300">{{ $item->ringkasan }}</textarea>
                                          </div>
                                          ...
                                          <div>
                                                ...
                                                <textarea name="poin_penting"
                                                      rows="4"
                                                      class="w-full rounded-xl border-slate-300">{{ $item->poin_penting }}</textarea>
                                          </div>
                                          ...
                                          <div>
                                                ...
                                                <textarea name="fakta_menarik"
                                                      rows="3"
                                                      class="w-full rounded-xl border-slate-300">{{ $item->fakta_menarik }}</textarea>
                                          </div>
                                          ...
                                          <div>
                                                ...
                                                @if($item->gambar_materi)
                                                <img src="{{ asset('storage/'.$item->gambar_materi) }}"
                                          ...
                                          <div class="flex justify-end gap-3 pt-4">
                                                ...
                                                <button type="submit"
                                                      class="px-5 py-2 bg-blue-700 text-white rounded-xl hover:bg-blue-800">
                                                      Update
                                                </button>
                                          </div>
