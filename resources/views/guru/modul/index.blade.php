    ...
    <tr class="text-gray-600">
        ...
        <th class="px-6 py-3 text-center">Aksi</th>
                    ...
                    <tbody class="divide-y">
                        @forelse ($modul as $index => $modul)
                            <tr class="hover:bg-gray-50">
                                <td class="px-6 py-3">{{ $index + 1 }}</td>
                                <td class="px-6 py-3">{{ $modul->judul }}</td>
                                <td class="px-6 py-3">{{ $modul->deskripsi }}</td>
        ...
        <path stroke-linecap="round"
              ...
              d="M2.458 12C3.732 7.943 7.523 5 12 5
                 ...
                 -4.477 0-8.268-2.943-9.542-7z" />
                                        ...
                                        {{-- Edit --}}
                                         <button 
                            @click="openEdit=true; editId={{ $modul->id }}"
                ...
                <path stroke-linecap="round"
                      ...
                      d="M11 5H6a2 2 0 00-2 2v11
                         ...
                         H9v-2.828l8.586-8.586z" />
                                        ...
                                        {{-- Hapus --}}
                                        <form action="{{ route('guru.modul.destroy', $modul->id) }}"
                                              method="POST"
...
<div
    ...
    <div
        ...
        <form
            action="{{ route('guru.modul.update', $modul->id) }}"
            method="POST"
            enctype="multipart/form-data"
            class="space-y-4">
            @csrf
            ...
            <textarea name="deskripsi" rows="2"
                class="w-full rounded-lg border-gray-300">{{ $modul->deskripsi }}</textarea>

            <textarea name="tujuan_pembelajaran" rows="2"
                class="w-full rounded-lg border-gray-300">{{ $modul->tujuan_pembelajaran }}</textarea>
